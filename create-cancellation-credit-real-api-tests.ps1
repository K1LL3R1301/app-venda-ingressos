...
if (Test-Path -LiteralPath $RunnerPath) {
  ...
  $BackupPath = "$RunnerPath.bak-cancel-credit-$StampBackup"
...
function Create-PaidOrderWithTicket {
  ...
  return @{
    ...
    unitPrice = To-DecimalNumber $ticket.orderItem.unitPrice
  }
}
...
Write-Host ""
Write-Host "Rode o teste real de cancelamento/credito:"
