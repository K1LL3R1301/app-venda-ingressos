...
function buildSectorTemplates(category, eventIndex) {
  ...
  if (category === "CONGRESSOS") {
    return [
      { name: "AuditÃ³rio Principal", type: "CHAIRS", occupancyMode: "RESERVED_SEATING", capacity: 260, color: "#2563eb", gateName: "Credenciamento A" },
      { name: "Ãrea VIP", type: "CHAIRS", occupancyMode: "RESERVED_SEATING", capacity: 100, color: "#7c3aed", gateName: "Credenciamento VIP" },
...
async function createOneEvent(index, organizer) {
  ...
  const event = await prisma.event.create({
    data: {
      ...
      content: {
        create: {
          headline: `${eventName}: uma experiÃªncia completa`,
          summary: `Resumo do ${eventName}.`,
          fullDescription: `DescriÃ§Ã£o completa do ${eventName}. Evento criado por seed para testar listagem, ediÃ§Ã£o, checkout, setores, lotes e mapas.`,
          attractions: "AtraÃ§Ã£o principal, convidados especiais e programaÃ§Ã£o completa.",
          schedule: "Abertura dos portÃµes, inÃ­cio do evento, intervalos e encerramento.",
          sectorDetails: "Setores com capacidades controladas por data e por lote.",
          importantInfo: "Chegue com antecedÃªncia e apresente documento com foto.",
      ...
      location: {
        create: {
          mode: "PRESENTIAL",
          venueName: `EspaÃ§o Seed ${((index % 12) + 1)}`,
          ...
          zipCode: "01001000",
          reference: "PrÃ³ximo ao ponto de referÃªncia principal.",
      ...
      policy: {
        create: {
          ...
          refundPolicy: "Reembolso conforme polÃ­tica do evento.",
          halfEntryPolicy: "Meia-entrada mediante documento comprobatÃ³rio.",
          transferPolicy: "TransferÃªncia permitida conforme regras do evento.",
          termsNotes: "Ao comprar, o cliente aceita os termos do evento.",
          entryRules: "Entrada mediante ingresso vÃ¡lido e documento oficial.",
