                    ...
                    >
                      ...
                      <div className="mt-4 flex flex-col gap-3 sm:flex-row">
                        <button
                          ...
                          className="rounded-2xl bg-[#ff6900] px-5 py-3 text-sm font-semibold text-white hover:bg-[#e85f00] disabled:cursor-not-allowed disabled:opacity-60"
                        >
                      ...
                      <div className="mt-4 flex flex-wrap gap-3">
                        {ticket.orderItem?.order?.id ? (
                          <button
                            type="button"
                            onClick={() =>
                              goTo(`/orders/${ticket.orderItem?.order?.id}`)
                            }
