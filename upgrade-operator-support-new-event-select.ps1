...
function Backup-File {
  ...
  if (Test-Path -LiteralPath $Path) {
    ...
    $BackupPath = "$Path.bak-operator-support-event-select-$Stamp"
...
Write-Host "[INFO] Atualizando /operator/support/new com lista de eventos do operador"
...
Write-Host "[OK] /operator/support/new atualizado com lista suspensa de eventos vinculados."
...
Write-Host ""
Write-Host "[OK] Tela de novo suporte do operador ajustada."
Write-Host ""
Write-Host "Agora rode:"
Write-Host "cd `"$WebRoot`""
Write-Host "npm run build *> log-web-operator-support-new-event-select-build.txt"
Write-Host "Select-String -Path .\log-web-operator-support-new-event-select-build.txt -Pattern `"error|Error:|Failed|Cannot find|Type error|Module not found|operator/support/new|operator-assignments|createSupportTicketReal|eventId|eventName`" -Context 2,3"
