...
$RunnerPath = Join-Path $ProjectRoot "run-ticket-transfer-return-real-api-tests.ps1"
...
if (Test-Path -LiteralPath $RunnerPath) {
  ...
  $BackupPath = "$RunnerPath.bak-transfer-return-$StampBackup"
...
Write-Host ""
Write-Host "Rode o teste:"
Write-Host "cd `"$ProjectRoot`""
Write-Host "powershell -ExecutionPolicy Bypass -File .\run-ticket-transfer-return-real-api-tests.ps1"
