...
Log: `C:\Users\march\OneDrive\Área de Trabalho\plataforma-ingressos\test-reports\v101b-20260515-083938\Prisma-validate.log`

### [WARN] Prisma generate

Falhou com codigo 1, mas marcado como opcional. Veja log.

Log: `C:\Users\march\OneDrive\Área de Trabalho\plataforma-ingressos\test-reports\v101b-20260515-083938\Prisma-generate.log`
...
Use -Build para rodar npm run build.
...
### [PASS] API Swagger docs

http://localhost:3001/docs respondeu HTTP 200

### [PASS] API base v1

http://localhost:3001/v1 respondeu HTTP 200
