...
Write-Host "[INFO] Recriando runner direto de QR com validacao de duplicidade ajustada"

if (Test-Path -LiteralPath $RunnerPath) {
  $StampBackup = Get-Date -Format "yyyyMMdd-HHmmss"
  $BackupPath = "$RunnerPath.bak-recreate-direct-qr-$StampBackup"
...
Write-Host "[OK] Runner recriado e validado:"
Write-Host "     $RunnerPath"
Write-Host ""
Write-Host "Obs.: o ticket usado no teste anterior ja ficou USED. Para testar -MarkAsUsed de novo, crie outro pedido novo primeiro."
